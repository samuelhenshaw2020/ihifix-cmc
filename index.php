...
<?php include('includes/index-header.php') ?>
        ...
        <section class="container-fluid x-bg-blu  bg-anime px-sm-3 pt-4" >
                 <main class="container">
                    <main class="pb-2 pt-5 px-sm-5  mx-auto col-md " ng-controller="searchCtrl">
                        <div class="text-center ">  
                            <h1 class="   font-weight-bold font-monserrat">
                                Get Online
                 ...
                 <div class="center-contain mx-auto">
                        <div class="autocomplete d-flex has-background-white shadow-sm  border  " style="border-radius: 2px; border-radius: 30px; overflow: hidden">
                                    <input type="text" class="input py-4 px-4 border-0 is-rouned has-bakground-light" placeholder="Search.."
                                    onfocus="$('#loc').hide('slow')" ng-keyup="search($event)">
        ...
        <main class=" center-contain mx-auto  ">
                    ...
                    <div class="index-show  " >
                        <div class="card p-2 pt-3 x-bg-red-light ">
                            ...
                            <span class="x-text-dark text-center small">Start</span>
                                <h5 class="mb-0 ">
                                    <a href="store.php" class="x-text-danger card-link stretched-link  font-weight-bold ">Shopping</a>
                                </h5>
                            </div>
                        </div>

                        <div class="card p-2 pt-3 x-bg-red-light  d-flex ">
                            <img src="img/topnav/store-col.svg"   class="m-auto " style="width: 45px"  >
                            <div class="card-body text-center p-1">
                            <span class="x-text-dark text-center small">Find</span>
                                <h5 class="mb-0 ">
                                    <a href="store.php" class=" x-text-danger card-link stretched-link  font-weight-bold ">Business</a>
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="card p-2 pt-3  x-bg-red-light  ">
                            ...
                            <span class="x-text-dark text-center small">Create</span>
                                <h5 class="mb-0 ">
                                    <a href="store.php" class=" x-text-danger card-link stretched-link  font-weight-bold ">Website</a>
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="card p-2 pt-3  x-bg-red-light  ">
                            ...
                            <span class="x-text-dark text-center small">List my</span>
                                <h5 class="mb-0 ">
                                    <a href="store.php" class=" x-text-danger stretched-link card-link  font-weight-bold ">Service</a>
                                </h5>
                            </div>
                        </div>
